      ...
      <div class="container">
        ...
        <div class="navbar-collapse">           	
          <ul class="nav navbar-nav navbar-right">
          	<li class="dropdown">
          		<a id="drop1" href="#" role="button" class="dropdown-toggle" data-toggle="dropdown"><i class="icon-user"></i> <span id="usuarioConectado">Ismael Cabañas García</span> <b class="caret"></b></a>
	...
	<div class="col-sm-2">
		<div id="MainMenu">
		  <div class="list-group panel">
		  	<a href="${pageContext.servletContext.contextPath}/paginas/club/listado.jsp?page=club" class="list-group-item list-group-item-success">Clubes</a>
		  	<!--
		    ...
		    <div class="collapse" id="menu1">
		     ...
		     -->
		    <a href="${pageContext.servletContext.contextPath}/paginas/corredores/listado.jsp?page=corredores" class="list-group-item list-group-item-success">Corredores</a>
		    <a href="${pageContext.servletContext.contextPath}/paginas/carreras/listado.jsp?page=carreras" class="list-group-item list-group-item-success">Carreras</a> 
		    <!--
