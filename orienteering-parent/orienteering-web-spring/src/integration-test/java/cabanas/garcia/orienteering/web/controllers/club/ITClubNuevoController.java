...
public class ITClubNuevoController {
	...
	public void la_peticion_de_nuevo_club_deberia_devolver_la_vista_del_formulario_de_alta_de_club() throws Exception {
		...
		MockHttpServletRequestBuilder peticionNuevoClub = get(RequestMappings.REQUEST_MAPPING_CLUB_ADMIN + RequestMappings.REQUEST_MAPPING_NEW)
				.contentType(MediaType.TEXT_HTML);				
		
		// WHEN
		ResultActions respuesta = mockMvc.perform(peticionNuevoClub);
