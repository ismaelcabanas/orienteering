...
public class ITClubActualizarController {

	private static final String NOMBRE_CLUB = "Pepito Club";
	private static final String ID_CLUB_A_ACTUALIZAR = "997";
	...
	@ExpectedDatabase(value="clubs-actualizar-esperado.xml", assertionMode=DatabaseAssertionMode.NON_STRICT)
	public void la_peticion_de_actualizar_club_deberia_redirigir_al_listado_de_clubs() throws Exception{
		...
		// WHEN
		ResultActions respuesta = mockMvc.perform(peticionActualizarClubsPorNombre);
